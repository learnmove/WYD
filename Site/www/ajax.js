...
request = new XMLHttpRequest();
 ...
 result.innerHTML = '<img src="images/progresso.gif"/>'; // Iniciar uma requisição 
 
 xmlreq.open("GET", "contato.php?txtnome=" + nome, true); 
 // Atribui uma função para ser executada sempre que houver uma mudança de ado 
 xmlreq.onreadystatechange = function(){ // Verifica se foi concluído com sucesso e a conexão fechada 
 (readyState=4)
