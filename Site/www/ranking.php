...
<head>
<title>Forsaken Destiny - Ranking</title>
...
<b id="server_time"></b></span>
	...
	<div id="meio">
	<div class="titulo">	       
		<div class="marcador_h1"></div><h1>RANKING</h1>
    </div>
    <ul id="breadcrumbs">
		<li><a href="https://m2.ongame.net/">Home</a></li>
		<li><span>>></span></li>					
		<li><a href="https://m2.ongame.net/ranking-personagem/">Ranking</a></li>
	</ul>
	<div class="box_conteudo">	       
		<div class="titulo_conteudo">
			<div class="marcador_h2"></div><h2><span>RANKING</span> PERSONAGEM</h2>
		</div>
		<div class="artigo">
			<!--Meu Ranking-->
				<style type="text/css">
	...
	.subtitulo_meu_ranking {
		background-color: #212121;
	}
</style>
	<center><p><i class="fa fa-clock-o"></i> Ranking sendo atualizado todo dia ás 00:00h. </center>

			<!--Meu Ranking-->
		</div>
	</div>
	<div class="box_conteudo" class="ranking_geral">
		<!--Menu Inicio-->
		...
		<div class="artigo">
						...
						<table class="tablef table-striped">
				<thead>
					<tr>
						
						<td width="5%">Posição</td>
						<td width="25%">Personagem</td>
						<td width="5%">Classe</td>
						<td width="5%">Nível</td>
						<td width="15%">Evolução</td>
					</tr>
				</thead>
				<tbody>
										<tr>
						...
						<td>Barramuthy</td>
						<td><img alt="FM" title="FM" src="images/foema.gif"></td>
						<td>120</td>
						<td>S.CELESTIAL</td>
					</tr>
										<tr>
						...
						<td>Gargoyles</td>
						<td><img alt="BM" title="BM" src="images/BeastMaster.gif"></td>
						<td>120</td>
						<td>S.CELESTIAL</td>
					</tr>
