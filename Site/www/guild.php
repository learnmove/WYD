...
<b id="server_time"></b></span>
    ...
    <ul id="breadcrumbs">
        ...
        <li><span>>></span></li>
        <li><a href="#">Guild Mark</a></li>
    </ul>
    <div style="color:#813232" class="alert">
<center>
<font face="Arial" size="3">
<IFRAME src="guildmake.php"width="650" height="550"  scrolling="no" frameborder="0" align="center"></IFRAME> 
