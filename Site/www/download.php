...
<head>
<title>Forsaken Destiny - Download</title>
...
<b id="server_time"></b></span>
    ...
    <ul id="breadcrumbs">
        ...
        <li><span>>></span></li>
        <li><a href="download.php">Download Jogo</a></li>
    </ul>
    <div id="box_download">
        <div id="texto_download">
            Para jogar Metin2, você precisa<br />
            baixar e instalar o CLIENT do jogo.<br /><br />
            Escolha uma das opções abaixo e divirta-se!
        </div>
                <div id="link_download">
            <a href="https://m2.ongame.net/download-jogo/Client">
                                    <p>Metin2 v15 [ 1.4 GB ]</p>
                            </a>
        </div>
            </div><br />
    <div id="mirror_sites" class="box_conteudo">
        <div class="titulo_conteudo">
            <div class="marcador_h2"></div>
            <h2><span>MIRROR</span>SITES</h2>
        </div>
        <p class="fonteBranca margin-left-20 margin-top-10 float-left">Você também pode fazer o download do Metin2 pelos links abaixo.</p>
        <div class="artigo">
			<ul class="ul_repositorios">
    								<li class="box_download" id="download_destaque">
					<div class="logo" id="logo_torrent"></div>
					<a class="link_download" href="https://m2.ongame.net/download-jogo/Torrent" target="_blank"></a>
					<div class="recomendacao fonteColor_2">+RECOMENDADO!</div>
				</li>
																																																										<li class="box_download">
					<div class="logo" id="logo_baixaki"></div>
					<a class="link_download" href="https://m2.ongame.net/download-jogo/Baixaki" target="_blank"></a>
					<div class="recomendacao"></div>
				</li>
																									<li class="box_download">
					<div class="logo" id="logo_superdownloads"></div>
					<a class="link_download" href="https://m2.ongame.net/download-jogo/Superdownloads" target="_blank"></a>
					<div class="recomendacao"></div>
				</li>
																																					<li class="box_download">
					<div class="logo" id="logo_ziggi"></div>
					<a class="link_download" href="https://m2.ongame.net/download-jogo/Ziggi" target="_blank"></a>
					<div class="recomendacao"></div>
				</li>
            																						<li class="box_download">
					<div class="logo" id="logo_techtudo"></div>
					<a class="link_download" href="https://m2.ongame.net/download-jogo/Techtudo" target="_blank"></a>
					<div class="recomendacao"></div>
				</li>
																			<li class="box_download">
					<div class="logo" id="logo_ultradownloads"></div>
					<a class="link_download" href="https://m2.ongame.net/download-jogo/Ultradownloads" target="_blank"></a>
					<div class="recomendacao"></div>
				</li>
																					</ul>
        </div>
            ...
            <div id="box_patchs" class="box_conteudo margin-top">
        <div class="titulo_conteudo">
            <div class="marcador_h2"></div>
            <h2><span>DOWNLOAD</span>PATCHES</h2>
        </div>
        <p class="fonteBranca margin-left-20 margin-top-10 float-left">Não conseguiu fazer o patch automático? Baixe a atualização aqui.</p>
        <div class="artigo">
                            <a href="https://m2.ongame.net/download-jogo/Manual 27.0">
                    <div id="box_patchs_jogo">
                        <div id="link_download_patchs">
                            <div class="texto_versao">Manual 27.0</div>
                        </div>
                    </div>
                </a>
                    </div>
    </div>
            <div id="box_download_drivers" class="box_conteudo margin-top">
        <div class="titulo_conteudo">
            <div class="marcador_h2"></div>
			<h2><span>DOWNLOAD</span>DRIVERS</h2>
        </div>
		<p class="fonteBranca margin-left-20 margin-top-10 float-left">A maioria dos problemas de áudio e vídeo são resolvidas atualizando seus drivers. Clique nos links abaixo e saiba como fazer a atualização.</p>
        <div class="artigo">
            <div id="texto_drivers">
                Atualize o driver da sua placa de vídeo.
            </div>
            <div id="radeon">
                <a target="_blank" href="http://support.amd.com/pt-br/download">
                    <img alt="Radeon" src="https://imagem.ongame.net/site_novo/global/download/ico_radeon.png"/>
                </a>
            </div>
            <div id="nvidia">
                <a target="_blank" href="http://www.nvidia.com.br/Download/index.aspx">
                    <img alt="nvidia" src="https://imagem.ongame.net/site_novo/global/download/ico_nvidia.png"/>
                </a>
            </div>
        </div>
    </div>
    <div id="box_download_directx" class="box_conteudo margin-top">
        <div class="titulo_conteudo">
            <div class="marcador_h2"></div>
            <h2><span>DOWNLOAD</span>DIRECTX</h2>
        </div>
        <p class="fonteBranca margin-left-20 margin-top-10 float-left">Metin2 roda a partir do Directx 9.0, caso seu computador tenha uma versão anterior, faça o download da nova versão aqui.</p>
        <div class="artigo">
            <div id="directx1"><a  target="_blank" href="https://support.microsoft.com/pt-br/kb/179113"><img alt="Direct X" src="https://imagem.ongame.net/site_novo/m2/global/downloads/directx/metin2_ico_directx10.png"/></a></div>
            <div id="directx2"><a  target="_blank" href="https://support.microsoft.com/pt-br/kb/179113"><img alt="Direct X" src="https://imagem.ongame.net/site_novo/m2/global/downloads/directx/metin2_ico_directx11.png"/></a></div>
        </div>
    </div>
    <div id="box_download_configuracoes" class="box_conteudo margin-top">
        <div class="titulo_conteudo">
            <div class="marcador_h2"></div>
            <h2><span>CONFIGURAÇÕES</span></h2>
        </div>
        <p class="fonteBranca margin-left-20 margin-top-10 float-left">Quer saber se o Metin2 roda em seu computador? Dê uma olhada nas configurações mínimas do jogo.</p>
        <div class="artigo">
			<div class="espaco_esquerdo margin-top-10">
				<table border="0" cellpadding="0" cellspacing="0" width="335" class="font_tabela espaco_esquerdo">
					<thead>
						<tr>
							<td colspan="2" class="tabela_titulo_fundo"><span class="font_tabela_titulo"><h2>Requisitos Mínimos</h2></span></td>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="tabela_linha1">Sistema Operacional</td>
							<td class="tabela_linha1">Windows XP, Vista, 7</td>
						</tr>
						<tr>
							<td class="tabela_linha2">Processador</td>
							<td class="tabela_linha2 borda_esquerda">P4 2.4Ghz ou Athlon 2500+</td>
						</tr>
						<tr>
							<td class="tabela_linha1">Memória RAM</td>
							<td class="tabela_linha1">RAM 512</td>
						</tr>
						<tr>
							<td class="tabela_linha2">Placa de Vídeo</td>
							<td class="tabela_linha2 borda_esquerda">Geforce 5700/Radeon 9600</td>
						</tr>
						<tr>
							<td class="tabela_linha1">DirectX</td>
							<td class="tabela_linha1">Directx 9.0c</td>
						</tr>
						<tr>
							<td class="tabela_linha2">Disco Rígido</td>
							<td class="tabela_linha2 borda_esquerda">1.5 GB de espaço livre</td>
						</tr>
						<tr>
							<td class="tabela_linha1">Internet</td>
							<td class="tabela_linha1">Banda Larga</td>
						</tr>
					</tbody>
				</table>
				<table border="0" cellpadding="0" cellspacing="0" width="335" class="font_tabela">
					<thead>
						<tr>
							<td colspan="2" class="tabela_titulo_fundo"><span class="font_tabela_titulo"><h2>Requisitos Recomendados</h2></span></td>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							<td class="tabela_linha2">Processador</td>
							<td class="tabela_linha2 borda_esquerda">P4 3Ghz ou Athlon 3000+</td>
						</tr>
						<tr>
							<td class="tabela_linha1">Memória RAM</td>
							<td class="tabela_linha1">RAM 1GB</td>
						</tr>
						<tr>
							<td class="tabela_linha2">Placa de Vídeo</td>
							<td class="tabela_linha2 borda_esquerda">Geforce 6600/Radeon X600</td>
						</tr>
						<tr>
							<td class="tabela_linha1">DirectX</td>
							<td class="tabela_linha1">Directx 9.0c ou mais recente</td>
						</tr>
						<tr>
							<td class="tabela_linha2">Disco Rígido</td>
							<td class="tabela_linha2 borda_esquerda">1.5 GB de espaço livre</td>
