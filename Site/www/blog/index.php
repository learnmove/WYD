...
<head>
<title>Forsaken Destiny - Blog</title>
...
<div id="meio">
    ...
    <ul id="breadcrumbs">
		...
		<li><span>>></span></li>
		<li><a href="https://m2.ongame.net/blog">GM BLOG</a></li>						
	</ul>
                                     			
   <div class="box_conteudo">	
    	       
        	<div class="titulo_conteudo">
        		<div class="marcador_h2">
        		</div><h2><span>TÍTULO</span></h2>
                <div class="data_titulo">DATA</div>
        	</div>
        	
        	<div class="artigo">
        		<ul class="ul_lista_noticias">
            		                        <li>
                        	<a href="https://m2.ongame.net/blog/6621-Abrindo o jogo!">
                        		<span class="titulo_noticia_lista">Quest Arch - Contrato dos espíritos</span> 
                        		<span class="data_conteudo">10.05.2017</span>
                        	</a>
                        </li>
                                            <li>
                        	<a href="https://m2.ongame.net/blog/6598-Algumas pequenas mudanças">
                        		<span class="titulo_noticia_lista">Algumas pequenas mudanças</span> 
                        		<span class="data_conteudo">10.05.2017</span>
                        	</a>
                        </li>
